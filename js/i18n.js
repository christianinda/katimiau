const I18N = {
  es: {
    ...
    "bedroom.listen": "Escuchar cuento 🔊",
    "bedroom.listening": "Escuchando... 🔊",
    "bedroom.surprise": "Cuento sorpresa",
    "bedroom.newSurprise": "🎲 Otra sorpresa",
    ...
    "food.thanks": "¡Gracias por esta rica comida, miau!",
    "drink.water": "Agua",
    "drink.milk": "Leche",
    "outfit.none": "Sin ropa",
    "outfit.dress": "Vestido rosa",
    "outfit.overalls": "Overol lavanda",
    "outfit.tshirt": "Polera y shorts",
    "outfit.tutu": "Tutú de bailarina",
    "outfit.cape": "Capa de superhéroe",
    "outfit.pajama": "Pijama de estrellitas",
    "outfit.shoesNone": "Sin zapatos",
    "outfit.shoesRed": "Zapatos rojos",
    "outfit.shoesYellow": "Zapatos amarillos",
    "outfit.shoesBlue": "Zapatillas azules",
    ...
    "story.moon.title": "El cuento de la lunita",
    "story.moon.text": "Muy arriba en el cielo vivía una lunita pequeñita llamada Luma, que tenía miedo de la oscuridad. Cada noche, las estrellas se juntaban a su alrededor y le prestaban un poquito de su brillo. Cuando Luma se sentía calentita y acompañada, cerraba los ojos despacio y se quedaba dormida meciéndose entre las nubes.",
    "story.fish.title": "El cuento del pez arcoíris",
    "story.fish.text": "En el fondo del mar vivía un pececito de escamas de colores llamado Coral. Le encantaba nadar despacito entre las algas mientras las burbujitas subían haciendo cosquillas. Cuando el sol se escondía detrás de las olas, Coral se escondía en su concha favorita, respiraba profundo y se dormía arrullado por el vaivén del agua.",
    "story.bear.title": "El cuento del osito",
    "story.bear.text": "En una cabañita del bosque vivía un osito suave y regalón llamado Miel. Todas las noches se abrazaba a su mantita favorita, escuchaba el canto lejano de los grillos y contaba ovejitas saltando despacio sobre una nube. Antes de llegar a diez, sus ojitos ya estaban cerrados y soñaba cosas hermosas.",
    "app.title": "Katimiau"
  },
  en: {
    "nav.home": "Home",
    ...
    "bedroom.listen": "Listen to story 🔊",
    "bedroom.listening": "Listening... 🔊",
    "bedroom.surprise": "Surprise story",
    "bedroom.newSurprise": "🎲 Another surprise",
    ...
    "food.thanks": "Thanks for this yummy food, meow!",
    "drink.water": "Water",
    "drink.milk": "Milk",
    "outfit.none": "No outfit",
    "outfit.dress": "Pink dress",
    "outfit.overalls": "Lavender overalls",
    "outfit.tshirt": "T-shirt and shorts",
    "outfit.tutu": "Ballerina tutu",
    "outfit.cape": "Superhero cape",
    "outfit.pajama": "Starry pajamas",
    "outfit.shoesNone": "No shoes",
    "outfit.shoesRed": "Red shoes",
    "outfit.shoesYellow": "Yellow shoes",
    "outfit.shoesBlue": "Blue sneakers",
    ...
    "story.moon.title": "The Little Moon's Tale",
    "story.moon.text": "High up in the sky lived a tiny little moon named Luma, who was afraid of the dark. Every night, the stars gathered around her and lent her a little bit of their sparkle. When Luma felt warm and less alone, she slowly closed her eyes and drifted off to sleep, swaying among the clouds.",
    "story.fish.title": "The Rainbow Fish's Tale",
    "story.fish.text": "Deep in the sea lived a little fish with colorful scales named Coral. She loved swimming slowly through the seaweed while tiny bubbles tickled her by. When the sun hid behind the waves, Coral tucked herself into her favorite shell, took a deep breath, and fell asleep, rocked by the gentle water.",
    "story.bear.title": "The Little Bear's Tale",
    "story.bear.text": "In a cozy cabin in the forest lived a soft, cuddly bear named Honey. Every night he hugged his favorite blanket, listened to the crickets singing far away, and counted little sheep hopping slowly over a cloud. Before he reached ten, his eyes were already closed, dreaming beautiful dreams.",
    "app.title": "Katimiau"
  }
};
...
function tOther(key){
  ...
  return (I18N[other] && I18N[other][key]) || key;
}

function biLabel(key){
  const primary = t(key);
  const secondary = tOther(key);
  if(primary === secondary) return primary;
  return `<span class="b-primary">${primary}</span><span class="b-secondary">${secondary}</span>`;
}
